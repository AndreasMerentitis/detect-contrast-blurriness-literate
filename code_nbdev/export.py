# AUTOGENERATED! DO NOT EDIT! File to edit: getiquality/detection.ipynb (unless otherwise specified).

__all__ = ['fix_image_size', 'estimate_blur', 'pretty_blur_map', 'check_contrast']
